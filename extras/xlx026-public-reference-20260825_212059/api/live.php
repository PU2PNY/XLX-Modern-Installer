...
/* XLX026_LIVE_OPERATOR_BRIDGE_V12 START */
...
$xlx026BaseCallV12 = static function (
    $value
): string {
    $value = strtoupper(
        trim((string)$value)
...
$xlx026GatewayPartsV12 = static function (
    $value
) use (
    $xlx026BaseCallV12
): array {
...
/* XLX026_LIVE_OPERATOR_BRIDGE_V12 END */
