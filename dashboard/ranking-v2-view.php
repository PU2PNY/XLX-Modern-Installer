...
<section class="rv2" id="rankingV2">
 <section class="rv2-display">
  <div class="rv2-brand">RANKING <?=htmlspecialchars($rv2Server, ENT_QUOTES, 'UTF-8')?></div>
  ...
  <div class="rv2-tabs"><button class="rv2-tab active" data-p="today">HOJE</button><button class="rv2-tab" data-p="week">7 DIAS</button><button class="rv2-tab" data-p="month">ESTE MÊS</button></div>
 </section>
 <section class="rv2-summary"><div class="rv2-box"><small>Transmissões</small><b id="rv2Tx">—</b></div><div class="rv2-box"><small>Tempo total falando</small><b id="rv2Air">—</b></div><div class="rv2-box"><small>Indicativos participantes</small><b id="rv2Users">—</b></div></section>
 <section class="rv2-grid"><article class="rv2-card"><h2><small>PTT / TX</small>Mais transmissões</h2><div id="rv2TopTx"></div></article><article class="rv2-card"><h2><small>TEMPO NO AR</small>Mais tempo falando</h2><div id="rv2TopAir"></div></article></section>
 <article class="rv2-card"><h2><small>DISPLAY DIGITAL</small>Comparativo de tempo falando</h2><div class="rv2-bars" id="rv2Bars"></div></article>
 <section class="rv2-aux"><article class="rv2-card"><h2><small>HORÁRIOS</small>Maior movimento</h2><div id="rv2Hours"></div></article><article class="rv2-card"><h2><small>MÓDULOS</small>Mais utilizados</h2><div id="rv2Mods"></div></article><article class="rv2-card"><h2><small>AGORA</small>Protocolos conectados</h2><div id="rv2Proto"></div></article></section>
