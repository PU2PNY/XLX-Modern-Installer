(function(){
 ...
 if(window.__XLXMODERN_A11Y_LIGHT_V5E__){
  return;
 }

 window.__XLXMODERN_A11Y_LIGHT_V5E__=true;
 ...
 function audioState(){
  ...
  if(
   ...
   typeof
   window.XLXMODERNAudioControl.state
   ==='function'
  ){
   try{
    return window.XLXMODERNAudioControl.state();
   }catch(error){}
  }
