...
const tutorials = [
      ...
      {
        id: "uDBUACMhOG0",
        title: "WPSD: conectar C4FM ao YSF{{YSF_ID}} do {{REFLECTOR_NAME}}",
        description: "Configuração prática do hotspot com WPSD para operar em C4FM/System Fusion conectado ao refletor YSF{{YSF_ID}} do {{REFLECTOR_NAME}}.",
        category: "reflector",
        label: "C4FM / WPSD"
      },
      {
      ...
      {
        id: "_EMeDCZWlMU",
        title: "DroidStar YSF/C4FM: conectar ao YSF{{YSF_ID}}",
        description: "Configuração do DroidStar para conectar e comunicar no refletor YSF{{YSF_ID}}, integrado ao ambiente C4FM do {{REFLECTOR_NAME}}.",
        category: "reflector",
        label: "YSF / DroidStar"
      },
      {
        id: "cGypXpI1kQo",
        title: "Conectar ao C4FM YSF{{YSF_ID}} usando rádio DMR",
        description: "Demonstra como configurar o hotspot Pi-Star em crossmode para acessar o C4FM/YSF{{YSF_ID}} com um rádio DMR.",
        category: "reflector",
        label: "Crossmode"
      }
    ];
