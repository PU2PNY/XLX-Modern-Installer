...
PACKAGES=(apache2 nginx php8.2-fpm build-essential ca-certificates certbot curl git iproute2 libapache2-mod-php libjson-c-dev libsqlite3-dev libssl-dev nftables openssl php php-cli php-curl php-mbstring php-sqlite3 php-xml procps python3 python3-certbot-apache python3-certbot-nginx pv rsync sqlite3 sudo unzip util-linux vnstat wget zip)
echo "mode=DRY_RUN"
