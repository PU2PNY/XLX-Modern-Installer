...
PACKAGES=(apache2 build-essential ca-certificates certbot curl git iproute2 libapache2-mod-php libjson-c-dev libsqlite3-dev libssl-dev nftables openssl php php-cli php-curl php-mbstring php-sqlite3 php-xml procps python3 python3-certbot-apache pv rsync sqlite3 sudo unzip util-linux vnstat wget zip)
echo "mode=DRY_RUN"
