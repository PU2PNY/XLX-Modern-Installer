...
TARGETS=(/etc/systemd/system/xlxd.service /etc/systemd/system/xlxecho.service /var/www/html/xlxd /var/www/html/xlxd-novo /usr/src/xlxd /usr/src/XLXEcho /usr/src/XLX_Dark_Dashboard /xlxd)
echo "mode=DRY_RUN"
