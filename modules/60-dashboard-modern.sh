...
# Fresh-install parity is validated against the deployed copy through Apache,
# before later modules can hide a broken frontend/data pipeline behind a
# successful-looking installation.
